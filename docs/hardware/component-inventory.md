...
This bill of materials lists the identified vehicle components and their
evidence state. Unknowns remain explicit rather than being replaced with
assumptions based on visually similar products.
...
**Evidence:** the product photograph I supplied and project source classes
...
**Evidence:** my confirmation that this board type was used and a project Python
serial experiment targeting an “Arduino” at 115200 baud.
...
used to control the assembled car.
...
| SEN-01 | RPLidar | RPLidar family | 2D scan input and obstacle corridor | **Project integration** | Exact model, serial, mount, scan rate |
| SEN-02 | Camera | Host camera index 0 | Video capture and YOLO inference | **Project integration** | Make/model, lens, resolution, mount, calibration |
| HMI-01 | Game controller | Xbox/PS-compatible | Steering, throttle, brake, direction | **Project integration** | Exact model, connection, verified mapping |
| HMI-02 | Windows computer | Windows host | GUI, device orchestration, perception | **Project integration** | Model, CPU/GPU, OS build, USB topology |
...
| ACT-03 | Brake system | Commanded brake actuator present | Engage/release braking | **Project behavior / hardware TBD** | Actuator, driver, fail state, pins |
...
Use stable names so the documentation can link directly to the physical record:
